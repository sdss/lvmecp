...
.. |lvmecp_version| replace:: {__version__}
"""
...
htmlhelp_basename = "{0}pdoc".format("lvmecp")
...
man_pages = [(master_doc, "lvmecp", "{0} Documentation".format(project), [author], 1)]
...
if use_releases == "yes":
    ...
    releases_github_path = "sdss/lvmecp"
